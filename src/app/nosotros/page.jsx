  ...
  return (
    <main style={{ minHeight: '100vh', paddingTop: '120px', paddingBottom: '90px', position: 'relative', overflow: 'hidden', color: 'var(--text)' }}>
      ...
      <div style={{ width: '85%', maxWidth: '1300px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
        ...
        {/* Hero */}
        <p style={{ textAlign: 'center', color: 'var(--accent-2)', fontSize: '0.8rem', fontWeight: 700, letterSpacing: '0.16em', textTransform: 'uppercase', marginBottom: '16px' }}>
          Quiénes somos
        </p>
        <h1 style={{ fontSize: 'clamp(2rem, 5vw, 3.2rem)', fontWeight: 900, color: 'var(--text-strong)', lineHeight: 1.1, textAlign: 'center', marginBottom: '22px' }}>
          Somos <span className="gradient-text">DigiSpherix</span>
        </h1>
        <p style={{ color: 'var(--text-muted)', fontSize: '1.1rem', lineHeight: 1.8, textAlign: 'center', maxWidth: '640px', margin: '0 auto 60px' }}>
        ...
        <section style={{ marginBottom: '64px' }}>
          <h2 style={{ fontSize: '1.7rem', fontWeight: 800, color: 'var(--text-strong)', marginBottom: '28px' }}>Nuestra historia</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div>
              <p style={{ color: 'var(--text-muted)', fontSize: '1rem', lineHeight: 1.9, marginBottom: '16px' }}>
            ...
            <div>
              <img
                ...
                height="800"
                loading="lazy"
                style={{ width: '100%', height: 'auto', borderRadius: '18px', border: '1px solid var(--border)', boxShadow: '0 20px 50px rgba(124,58,237,0.18)', display: 'block' }}
              />
            </div>
          </div>
        </section>
        ...
        {/* Qué hacemos */}
        <section style={{ marginBottom: '64px' }}>
          <h2 style={{ fontSize: '1.7rem', fontWeight: 800, color: 'var(--text-strong)', marginBottom: '28px' }}>Qué hacemos</h2>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '18px' }}>
            {servicios.map((s) => (
              <div key={s.title} style={{ background: 'var(--bg-card)', border: '1px solid var(--border)', borderRadius: '16px', padding: '26px' }}>
                <div style={{ width: '46px', height: '46px', borderRadius: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(124,58,237,0.18)', color: 'var(--accent-3)', marginBottom: '16px' }}>
                  <s.icon size={22} />
                </div>
                <h3 style={{ fontSize: '1.05rem', fontWeight: 700, color: 'var(--text-strong)', marginBottom: '8px' }}>{s.title}</h3>
        ...
        <section style={{ marginBottom: '64px' }}>
          <h2 style={{ fontSize: '1.7rem', fontWeight: 800, color: 'var(--text-strong)', marginBottom: '28px' }}>Misión, visión y valores</h2>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '18px', marginBottom: '18px' }}>
            <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border)', borderRadius: '16px', padding: '28px' }}>
              ...
              <h3 style={{ fontSize: '1.1rem', fontWeight: 700, color: 'var(--text-strong)', marginBottom: '8px' }}>Misión</h3>
            ...
            <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border)', borderRadius: '16px', padding: '28px' }}>
              <div style={{ width: '46px', height: '46px', borderRadius: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(217,70,239,0.18)', color: 'var(--accent-4)', marginBottom: '16px' }}>
                <Compass size={22} />
              </div>
              <h3 style={{ fontSize: '1.1rem', fontWeight: 700, color: 'var(--text-strong)', marginBottom: '8px' }}>Visión</h3>
              <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem', lineHeight: 1.75 }}>
          ...
          <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border)', borderRadius: '16px', padding: '28px' }}>
            <h3 style={{ fontSize: '1.1rem', fontWeight: 700, color: 'var(--text-strong)', marginBottom: '18px' }}>Nuestros valores</h3>
            <ul style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '14px', listStyle: 'none', padding: 0 }}>
              {[
                ...
                <li key={titulo} style={{ display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
                  <span style={{ width: '22px', height: '22px', borderRadius: '50%', flexShrink: 0, marginTop: '2px', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(217,70,239,0.2)', color: 'var(--accent-4)' }}>
                    <Check size={13} strokeWidth={3} />
                  </span>
                  <span style={{ color: 'var(--text-muted)', fontSize: '0.92rem', lineHeight: 1.55 }}>
                    <span style={{ color: 'var(--text-strong)', fontWeight: 700 }}>{titulo}.</span> {texto}
                  </span>
                </li>
              ))}
            </ul>
        ...
        {/* Valores */}
        <section style={{ marginBottom: '64px' }}>
          <h2 style={{ fontSize: '1.7rem', fontWeight: 800, color: 'var(--text-strong)', marginBottom: '28px' }}>Por qué elegirnos</h2>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
            {valores.map((v) => (
              <div key={v.title} style={{ display: 'flex', gap: '18px', alignItems: 'flex-start', background: 'var(--bg-card)', border: '1px solid var(--border)', borderRadius: '16px', padding: '24px' }}>
                <div style={{ width: '48px', height: '48px', borderRadius: '12px', flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, rgba(124,58,237,0.25), rgba(217,70,239,0.15))', color: 'var(--accent-4)' }}>
                  <v.icon size={22} />
                </div>
                <div>
                  <h3 style={{ fontSize: '1.1rem', fontWeight: 700, color: 'var(--text-strong)', marginBottom: '6px' }}>{v.title}</h3>
                  <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem', lineHeight: 1.7 }}>{v.desc}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        {/* CTA */}
        <section style={{ textAlign: 'center', background: 'linear-gradient(135deg, rgba(124,58,237,0.12), rgba(217,70,239,0.08))', border: '1px solid var(--border)', borderRadius: '20px', padding: '44px 32px' }}>
          <div style={{ fontSize: '2.2rem', marginBottom: '14px' }}>🚀</div>
          <h2 style={{ fontSize: '1.5rem', fontWeight: 800, color: 'var(--text-strong)', marginBottom: '12px' }}>¿Trabajamos juntos?</h2>
          <p style={{ color: 'var(--text-muted)', maxWidth: '460px', margin: '0 auto 24px', lineHeight: 1.7 }}>
