...
export const tools = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: '¿Puedo convertir mi video a otro formato?', a: 'Sí, con nuestra herramienta Convertir Video puedes pasar tu video a MP4, MOV, MKV, TS o WebM. Esta de aquí se enfoca en recortar y extraer audio.' },
  ...
  },
  {
    ...
    tagline: 'Pasa tu video a MP4, MOV, MKV, TS o WebM',
    description:
      'Convierte tus videos entre MP4, MOV, MKV, TS y WebM directo en tu navegador. Sin instalar programas y sin subir tu video a internet.',
    icon: 'FileVideo',
    accent: '#2563eb',
    ready: true,
    ...
    howItWorks: [
      ...
      'Elige el formato de destino: MP4, MOV, MKV, TS o WebM.',
    ...
    faqs: [
      ...
      { q: '¿Por qué unos formatos son rápidos y otros lentos?', a: 'Cambiar solo el contenedor (MP4, MOV, MKV, TS) suele ser casi instantáneo porque no recomprime el video. Convertir a WebM (o desde WebM) sí recomprime, así que puede tardar varios minutos.' },
      ...
      { q: '¿Hay límite de duración?', a: 'No hay un límite fijo, pero como todo se procesa en tu dispositivo, funciona mejor con videos de máximo 1 minuto, sobre todo al convertir a WebM.' },
      { q: '¿Cuál formato me conviene?', a: 'MP4 es el más compatible para redes y web. MOV es común en Apple, MKV para archivar y TS para streaming. WebP y WebM son ligeros para web.' },
