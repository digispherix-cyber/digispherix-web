...
export const tools = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: '¿Puedo convertir mi video a otro formato?', a: 'Sí, con nuestra herramienta Convertir Video puedes pasar tu video a MP4, MOV, MKV o TS. Esta de aquí se enfoca en recortar y extraer audio.' },
  ...
  {
    slug: 'subtitulos-video',
    name: 'Subtítulos para Video',
    tagline: 'Subtítulos automáticos con IA, con estilo, para tus videos',
    description:
      'Sube un video (hasta 60s), genera subtítulos automáticos con inteligencia artificial, dales estilo (color, borde, fuente, posición) y descarga el video con los subtítulos ya puestos. Ideal para Reels, TikTok y Shorts.',
    icon: 'Captions',
    accent: '#8b5cf6',
    ready: true,
    privacyNote: 'todo se procesa en tu navegador',
    howItWorks: [
      'Sube tu video (máximo 60 segundos) y elige el idioma.',
      'La IA transcribe el audio y crea los subtítulos con sus tiempos. Edítalos si hace falta.',
      'Dale estilo y descarga el video con los subtítulos incrustados (o el archivo .SRT).',
    ],
    faqs: [
  ...
  },
  {
    ...
    tagline: 'Pasa tu video a MP4, MOV, MKV o TS',
    description:
      'Convierte tus videos entre MP4, MOV, MKV y TS directo en tu navegador. Acepta también videos WebM como origen. Sin instalar programas y sin subir tu video a internet.',
    icon: 'FileVideo',
    accent: '#2563eb',
    ready: true,
    privacyNote: 'tu video se convierte en tu navegador',
    howItWorks: [
      'Sube o arrastra tu video (idealmente de máximo 1 minuto).',
      'Elige el formato de destino: MP4, MOV, MKV o TS.',
      'Convierte y descarga el resultado. Nada se sube a internet.',
    ],
    faqs: [
      { q: '¿Mi video se sube a internet?', a: 'No. La conversión ocurre en tu navegador con tecnología ffmpeg; tu video nunca sale de tu dispositivo.' },
      { q: '¿Por qué unas conversiones son rápidas y otras lentas?', a: 'Cambiar solo el contenedor (por ejemplo de MP4 a MOV, MKV o TS) suele ser casi instantáneo porque no recomprime el video. Convertir un video WebM sí requiere recomprimirlo, así que puede tardar varios minutos.' },
      { q: '¿Puedo convertir un video WebM a MP4?', a: 'Sí. Los WebM (como los del grabador de pantalla) se pueden convertir a MP4, MOV, MKV o TS. Esa conversión recomprime el video, así que tarda un poco más.' },
      { q: '¿Puedo obtener un archivo WebM?', a: 'Por ahora no. El motor ligero que corre en tu navegador convierte hacia MP4, MOV, MKV y TS. Para la web, te recomendamos MP4, que es igual de compatible.' },
      { q: '¿Por qué la primera vez tarda?', a: 'La primera vez se descarga el motor de conversión (unos 30 MB) a tu navegador. Después queda en caché y es más rápido.' },
      { q: '¿Cuál formato me conviene?', a: 'MP4 es el más compatible para redes sociales y web. MOV es común en equipos Apple, MKV sirve para archivar y TS para streaming.' },
      { q: '¿Funciona en el celular?', a: 'Funciona mejor en computadora. En celulares con poca memoria, los videos grandes pueden fallar por el tamaño del motor de conversión.' },
      { q: '¿Es gratis?', a: 'Sí, totalmente gratis y sin registro.' },
    ],
  },
]
