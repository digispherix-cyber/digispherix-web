...
const plans = {
  ...
  Marketing: [
    ...
    },
    {
      ...
      renewal: 'No incluye el presupuesto de anuncios',
      cta: 'Cotizar',
      highlight: true,
    },
    {
      ...
      price: '$22,000',
      period: 'por mes',
      desc: 'Estrategia integral: SEO, campañas de pago y contenido, con reportes semanales.',
      features: ['Todas las plataformas', '30 publicaciones/mes', 'SEO + Ads + Email', 'Estrategia de marca', 'Gestión de pauta hasta $20,000/mes', 'Reportes semanales', 'Soporte prioritario'],
      renewal: 'No incluye el presupuesto de anuncios',
      cta: 'Cotizar',
      highlight: false,
    },
